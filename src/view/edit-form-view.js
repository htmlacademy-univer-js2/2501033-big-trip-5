...
export default class EditFormView extends AbstractView {
  ...
  get template() {
    const { type, destination, base_price, date_from, date_to } = this.point;
    const cityName = destination ? destination.name : '???';
          ...
          <header class="event__header">
            <div class="event__type-wrapper">
              ...
              <div class="event__type-list">
                <fieldset class="event__type-group">
                  ...
                  <div class="event__type-item">
                    <input id="event-type-flight-1"
                           class="event__type-input  visually-hidden"
                           type="radio" name="event-type" value="flight">
                    <label class="event__type-label  event__type-label--flight" for="event-type-flight-1">Flight</label>
                  </div>

                  <div class="event__type-item">
                    <input id="event-type-check-in-1"
                           class="event__type-input  visually-hidden"
            ...
            <div class="event__field-group  event__field-group--destination">
              ...
              <input class="event__input  event__input--destination"
                     ...
                     value="${cityName}" list="destination-list-1">
